...
#         db.delete_unique('cancer_subject_subjectconsent', ['subject_identifier'])
# 
#         # Deleting field 'SubjectConsent.witness_name'
#         db.delete_column('cancer_subject_subjectconsent', 'witness_name')
# 
#         # Deleting field 'SubjectConsent.is_literate'
#         db.delete_column('cancer_subject_subjectconsent', 'is_literate')
# 
#         # Deleting field 'SubjectConsent.subject_identifier_as_pk'
#         db.delete_column('cancer_subject_subjectconsent', 'subject_identifier_as_pk')
# 
#         # Changing field 'SubjectConsent.subject_identifier'
#         db.alter_column('cancer_subject_subjectconsent', 'subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=36, null=True))
# 
#         # Deleting field 'SubjectConsentAudit.is_literate'
#         db.delete_column('cancer_subject_subjectconsent_audit', 'is_literate')
# 
#         # Deleting field 'SubjectConsentAudit.subject_identifier_as_pk'
#         db.delete_column('cancer_subject_subjectconsent_audit', 'subject_identifier_as_pk')
# 
#         # Deleting field 'SubjectConsentAudit.witness_name'
#         db.delete_column('cancer_subject_subjectconsent_audit', 'witness_name')
# 
#         # Changing field 'SubjectConsentAudit.subject_identifier'
#         db.alter_column('cancer_subject_subjectconsent_audit', 'subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=36, null=True))

        # Changing field 'SymptomsAndTesting.symptom_prompt'
        db.alter_column('cancer_subject_symptomsandtesting', 'symptom_prompt', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'SymptomsAndTestingAudit.symptom_prompt'
        db.alter_column('cancer_subject_symptomsandtesting_audit', 'symptom_prompt', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):
        
        # Adding field 'SubjectConsent.witness_name'
        db.add_column('cancer_subject_subjectconsent', 'witness_name', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True), keep_default=False)

        # Adding field 'SubjectConsent.is_literate'
        db.add_column('cancer_subject_subjectconsent', 'is_literate', self.gf('django.db.models.fields.CharField')(default='-', max_length=3), keep_default=False)

        # Adding field 'SubjectConsent.subject_identifier_as_pk'
        db.add_column('cancer_subject_subjectconsent', 'subject_identifier_as_pk', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, db_index=True), keep_default=False)

        # Changing field 'SubjectConsent.subject_identifier'
        db.alter_column('cancer_subject_subjectconsent', 'subject_identifier', self.gf('django.db.models.fields.CharField')(default='', max_length=50, unique=True))

        # Adding unique constraint on 'SubjectConsent', fields ['subject_identifier']
        db.create_unique('cancer_subject_subjectconsent', ['subject_identifier'])

        # Adding field 'SubjectConsentAudit.is_literate'
        db.add_column('cancer_subject_subjectconsent_audit', 'is_literate', self.gf('django.db.models.fields.CharField')(default='-', max_length=3), keep_default=False)

        # Adding field 'SubjectConsentAudit.subject_identifier_as_pk'
        db.add_column('cancer_subject_subjectconsent_audit', 'subject_identifier_as_pk', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, db_index=True), keep_default=False)

        # Adding field 'SubjectConsentAudit.witness_name'
        db.add_column('cancer_subject_subjectconsent_audit', 'witness_name', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True), keep_default=False)

        # Changing field 'SubjectConsentAudit.subject_identifier'
        db.alter_column('cancer_subject_subjectconsent_audit', 'subject_identifier', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'SymptomsAndTesting.symptom_prompt'
        db.alter_column('cancer_subject_symptomsandtesting', 'symptom_prompt', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'SymptomsAndTestingAudit.symptom_prompt'
        db.alter_column('cancer_subject_symptomsandtesting_audit', 'symptom_prompt', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'cancer_subject.activityandfunctioning': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 15, 8, 44, 51, 973477)'}),
        ...
        'cancer_subject.locator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 5, 15)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 15, 8, 44, 51, 774213)'}),
        ...
        'cancer_subject.locatoraudit': {
            ...
            'subject_phone': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True', 'blank': 'True'}),
            'subject_phone_alt': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True', 'blank': 'True'}),
            'subject_visit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_locator'", 'null': 'True', 'to': "orm['cancer_subject.SubjectVisit']"}),
            'subject_work_phone': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True', 'blank': 'True'}),
            'subject_work_place': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        ...
        'cancer_subject.subjectconsent': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'original_identifier': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
        ...
        'cancer_subject.symptomsandtestingaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'SymptomsAndTestingAudit', 'db_table': "'cancer_subject_symptomsandtesting_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_subject_identifier': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
