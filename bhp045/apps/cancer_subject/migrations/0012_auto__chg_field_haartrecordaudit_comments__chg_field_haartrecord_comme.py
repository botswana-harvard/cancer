...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HaartRecordAudit.comments'
        db.alter_column('cancer_subject_haartrecord_audit', 'comments', self.gf('django.db.models.fields.TextField')(max_length=150, null=True))

        # Changing field 'HaartRecord.comments'
        db.alter_column('cancer_subject_haartrecord', 'comments', self.gf('django.db.models.fields.TextField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'HaartRecordAudit.comments'
        db.alter_column('cancer_subject_haartrecord_audit', 'comments', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'HaartRecord.comments'
        db.alter_column('cancer_subject_haartrecord', 'comments', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))
    ...
    models = {
        ...
        'cancer_subject.activityandfunctioning': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 21, 0, 0)'}),
        ...
        'cancer_subject.locator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 21, 0, 0)'}),
