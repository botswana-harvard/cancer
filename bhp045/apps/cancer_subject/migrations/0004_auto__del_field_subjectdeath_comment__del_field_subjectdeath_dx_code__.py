...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SubjectDeath.comment'
        db.delete_column('cancer_subject_subjectdeath', 'comment')

        # Deleting field 'SubjectDeath.dx_code'
        db.delete_column('cancer_subject_subjectdeath', 'dx_code_id')

        # Deleting field 'SubjectDeath.illness_duration'
        db.delete_column('cancer_subject_subjectdeath', 'illness_duration')

        # Deleting field 'SubjectDeath.perform_autopsy'
        db.delete_column('cancer_subject_subjectdeath', 'perform_autopsy')

        # Deleting field 'SubjectDeath.death_medical_responsibility'
        db.delete_column('cancer_subject_subjectdeath', 'death_medical_responsibility_id')

        # Adding field 'SubjectDeath.comments'
        db.add_column('cancer_subject_subjectdeath', 'comments',
                      self.gf('django.db.models.fields.TextField')(default=0, max_length=250),
                      keep_default=False)

        # Deleting field 'SubjectDeathAudit.comment'
        db.delete_column('cancer_subject_subjectdeath_audit', 'comment')

        # Deleting field 'SubjectDeathAudit.dx_code'
        db.delete_column('cancer_subject_subjectdeath_audit', 'dx_code_id')

        # Deleting field 'SubjectDeathAudit.illness_duration'
        db.delete_column('cancer_subject_subjectdeath_audit', 'illness_duration')

        # Deleting field 'SubjectDeathAudit.perform_autopsy'
        db.delete_column('cancer_subject_subjectdeath_audit', 'perform_autopsy')

        # Deleting field 'SubjectDeathAudit.death_medical_responsibility'
        db.delete_column('cancer_subject_subjectdeath_audit', 'death_medical_responsibility_id')

        # Adding field 'SubjectDeathAudit.comments'
        db.add_column('cancer_subject_subjectdeath_audit', 'comments',
                      self.gf('django.db.models.fields.TextField')(default=0, max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SubjectDeath.comment'
        db.add_column('cancer_subject_subjectdeath', 'comment',
                      self.gf('django.db.models.fields.TextField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubjectDeath.dx_code'
        db.add_column('cancer_subject_subjectdeath', 'dx_code',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_code_lists.DxCode'], max_length=25),
                      keep_default=False)

        # Adding field 'SubjectDeath.illness_duration'
        db.add_column('cancer_subject_subjectdeath', 'illness_duration',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'SubjectDeath.perform_autopsy'
        db.add_column('cancer_subject_subjectdeath', 'perform_autopsy',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=3),
                      keep_default=False)

        # Adding field 'SubjectDeath.death_medical_responsibility'
        db.add_column('cancer_subject_subjectdeath', 'death_medical_responsibility',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_adverse.DeathMedicalResponsibility']),
                      keep_default=False)

        # Deleting field 'SubjectDeath.comments'
        db.delete_column('cancer_subject_subjectdeath', 'comments')

        # Adding field 'SubjectDeathAudit.comment'
        db.add_column('cancer_subject_subjectdeath_audit', 'comment',
                      self.gf('django.db.models.fields.TextField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubjectDeathAudit.dx_code'
        db.add_column('cancer_subject_subjectdeath_audit', 'dx_code',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='_audit_subjectdeath', max_length=25, to=orm['bhp_code_lists.DxCode']),
                      keep_default=False)

        # Adding field 'SubjectDeathAudit.illness_duration'
        db.add_column('cancer_subject_subjectdeath_audit', 'illness_duration',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'SubjectDeathAudit.perform_autopsy'
        db.add_column('cancer_subject_subjectdeath_audit', 'perform_autopsy',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=3),
                      keep_default=False)

        # Adding field 'SubjectDeathAudit.death_medical_responsibility'
        db.add_column('cancer_subject_subjectdeath_audit', 'death_medical_responsibility',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='_audit_subjectdeath', to=orm['bhp_adverse.DeathMedicalResponsibility']),
                      keep_default=False)

        # Deleting field 'SubjectDeathAudit.comments'
        db.delete_column('cancer_subject_subjectdeath_audit', 'comments')
    ...
    models = {
        ...
        'cancer_subject.activityandfunctioning': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 10, 0, 0)'}),
        ...
        'cancer_subject.locator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 10, 0, 0)'}),
        ...
        'cancer_subject.subjectdeath': {
            ...
            'comments': ('django.db.models.fields.TextField', [], {'max_length': '250'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
