...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cancer_subject_locator_audit', 'subject_visit_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cancer_subject.SubjectVisit']))

        # Changing field 'SubjectConsent.original_identifier'
        db.alter_column('cancer_subject_subjectconsent', 'original_identifier', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

        # Changing field 'SubjectConsentAudit.original_identifier'
        db.alter_column('cancer_subject_subjectconsent_audit', 'original_identifier', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

        # Changing field 'Locator.subject_visit'
        db.alter_column('cancer_subject_locator', 'subject_visit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cancer_subject.SubjectVisit'], null=True))

    def backwards(self, orm):

        # Changing field 'LocatorAudit.subject_visit'
        db.alter_column('cancer_subject_locator_audit', 'subject_visit_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cancer_subject.SubjectVisit']))

        # Changing field 'SubjectConsent.original_identifier'
        db.alter_column('cancer_subject_subjectconsent', 'original_identifier', self.gf('django.db.models.fields.CharField')(default=0, max_length=12))

        # Changing field 'SubjectConsentAudit.original_identifier'
        db.alter_column('cancer_subject_subjectconsent_audit', 'original_identifier', self.gf('django.db.models.fields.CharField')(default=0, max_length=12))

        # Changing field 'Locator.subject_visit'
        db.alter_column('cancer_subject_locator', 'subject_visit_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cancer_subject.SubjectVisit']))
    ...
    models = {
        ...
        'cancer_subject.activityandfunctioning': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 26, 0, 0)'}),
        ...
        'cancer_subject.locator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 26, 0, 0)'}),
