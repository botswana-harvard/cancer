...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HaartRecordAudit.haart_status'
        db.alter_column('cancer_subject_haartrecord_audit', 'haart_status', self.gf('django.db.models.fields.CharField')(max_length=145, null=True))

        # Changing field 'HaartRecord.haart_status'
        db.alter_column('cancer_subject_haartrecord', 'haart_status', self.gf('django.db.models.fields.CharField')(max_length=145, null=True))

    def backwards(self, orm):

        # Changing field 'HaartRecordAudit.haart_status'
        db.alter_column('cancer_subject_haartrecord_audit', 'haart_status', self.gf('django.db.models.fields.CharField')(default=0, max_length=145))

        # Changing field 'HaartRecord.haart_status'
        db.alter_column('cancer_subject_haartrecord', 'haart_status', self.gf('django.db.models.fields.CharField')(default=0, max_length=145))
