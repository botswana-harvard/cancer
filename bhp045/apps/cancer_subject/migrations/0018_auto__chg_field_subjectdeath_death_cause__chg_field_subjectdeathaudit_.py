...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubjectDeath.death_cause'
        db.alter_column('cancer_subject_subjectdeath', 'death_cause', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))

        # Changing field 'SubjectDeathAudit.death_cause'
        db.alter_column('cancer_subject_subjectdeath_audit', 'death_cause', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'SubjectDeath.death_cause'
        db.alter_column('cancer_subject_subjectdeath', 'death_cause', self.gf('django.db.models.fields.TextField')(default=0, max_length=1000))

        # Changing field 'SubjectDeathAudit.death_cause'
        db.alter_column('cancer_subject_subjectdeath_audit', 'death_cause', self.gf('django.db.models.fields.TextField')(default=0, max_length=1000))
