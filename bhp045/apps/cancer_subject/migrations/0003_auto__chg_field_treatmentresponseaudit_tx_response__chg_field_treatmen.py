...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cancer_subject_treatmentresponse_audit', 'tx_response', self.gf('django.db.models.fields.TextField')(max_length=350))

        # Changing field 'TreatmentResponse.tx_response'
        db.alter_column('cancer_subject_treatmentresponse', 'tx_response', self.gf('django.db.models.fields.TextField')(max_length=350))
