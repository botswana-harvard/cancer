...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        VisitDefinition = orm['bhp_visit.VisitDefinition']
        ContentTypeMap = orm['bhp_content_type_map.ContentTypeMap']
        subject_visit_content_type_map = ContentTypeMap.objects.get(model='SubjectVisit')
        for visit_definition in VisitDefinition.objects.all():
            visit_definition.visit_tracking_content_type_map = subject_visit_content_type_map
    ...
    models = {
        ...
        'cancer_subject.activityandfunctioning': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 17, 0, 0)'}),
        ...
        'cancer_subject.locator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 17, 0, 0)'}),
