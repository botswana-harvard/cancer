...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cancer_subject_subjectconsent', 'original_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'SubjectConsentAudit.original_identifier'
        db.alter_column('cancer_subject_subjectconsent_audit', 'original_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
    ...
    models = {
        ...
        'cancer_subject.activityandfunctioning': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 27, 0, 0)'}),
        ...
        'cancer_subject.locator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 27, 0, 0)'}),
