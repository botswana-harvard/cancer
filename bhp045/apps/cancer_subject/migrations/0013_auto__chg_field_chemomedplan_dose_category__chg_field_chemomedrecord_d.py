...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChemoMedPlan.dose_category'
        db.alter_column('cancer_subject_chemomedplan', 'dose_category', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'ChemoMedRecord.dose_category'
        db.alter_column('cancer_subject_chemomedrecord', 'dose_category', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'ChemoMedPlanAudit.dose_category'
        db.alter_column('cancer_subject_chemomedplan_audit', 'dose_category', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'ChemoMedRecordAudit.dose_category'
        db.alter_column('cancer_subject_chemomedrecord_audit', 'dose_category', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

    def backwards(self, orm):

        # Changing field 'ChemoMedPlan.dose_category'
        db.alter_column('cancer_subject_chemomedplan', 'dose_category', self.gf('django.db.models.fields.CharField')(default=0, max_length=35))

        # Changing field 'ChemoMedRecord.dose_category'
        db.alter_column('cancer_subject_chemomedrecord', 'dose_category', self.gf('django.db.models.fields.CharField')(default=0, max_length=35))

        # Changing field 'ChemoMedPlanAudit.dose_category'
        db.alter_column('cancer_subject_chemomedplan_audit', 'dose_category', self.gf('django.db.models.fields.CharField')(default=0, max_length=35))

        # Changing field 'ChemoMedRecordAudit.dose_category'
        db.alter_column('cancer_subject_chemomedrecord_audit', 'dose_category', self.gf('django.db.models.fields.CharField')(default=0, max_length=35))
    ...
    models = {
        ...
        'cancer_subject.activityandfunctioning': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 22, 0, 0)'}),
        ...
        'cancer_subject.locator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 22, 0, 0)'}),
