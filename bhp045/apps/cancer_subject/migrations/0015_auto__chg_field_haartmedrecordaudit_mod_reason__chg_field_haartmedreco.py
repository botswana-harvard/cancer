...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HaartMedRecordAudit.mod_reason'
        db.alter_column('cancer_subject_haartmedrecord_audit', 'mod_reason', self.gf('django.db.models.fields.CharField')(max_length=65, null=True))

        # Changing field 'HaartMedRecord.mod_reason'
        db.alter_column('cancer_subject_haartmedrecord', 'mod_reason', self.gf('django.db.models.fields.CharField')(max_length=65, null=True))

    def backwards(self, orm):

        # Changing field 'HaartMedRecordAudit.mod_reason'
        db.alter_column('cancer_subject_haartmedrecord_audit', 'mod_reason', self.gf('django.db.models.fields.CharField')(default=0, max_length=65))

        # Changing field 'HaartMedRecord.mod_reason'
        db.alter_column('cancer_subject_haartmedrecord', 'mod_reason', self.gf('django.db.models.fields.CharField')(default=0, max_length=65))
    ...
    models = {
        ...
        'cancer_subject.activityandfunctioning': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 5, 0, 0)'}),
        ...
        'cancer_subject.locator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 5, 0, 0)'}),
