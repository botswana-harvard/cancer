...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cancer_subject_chemomedplan', 'cycle_num', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ChemoMedRecord.cycle_num'
        db.alter_column('cancer_subject_chemomedrecord', 'cycle_num', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ChemoMedPlanAudit.cycle_num'
        db.alter_column('cancer_subject_chemomedplan_audit', 'cycle_num', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ChemoMedRecordAudit.cycle_num'
        db.alter_column('cancer_subject_chemomedrecord_audit', 'cycle_num', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ChemoMedPlan.cycle_num'
        db.alter_column('cancer_subject_chemomedplan', 'cycle_num', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'ChemoMedRecord.cycle_num'
        db.alter_column('cancer_subject_chemomedrecord', 'cycle_num', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'ChemoMedPlanAudit.cycle_num'
        db.alter_column('cancer_subject_chemomedplan_audit', 'cycle_num', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'ChemoMedRecordAudit.cycle_num'
        db.alter_column('cancer_subject_chemomedrecord_audit', 'cycle_num', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        'cancer_subject.activityandfunctioning': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 1, 0, 0)'}),
        ...
        'cancer_subject.locator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 1, 0, 0)'}),
