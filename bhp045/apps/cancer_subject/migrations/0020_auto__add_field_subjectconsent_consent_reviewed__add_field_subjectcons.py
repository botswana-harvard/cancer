...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubjectConsent.consent_reviewed'
        db.add_column('cancer_subject_subjectconsent', 'consent_reviewed',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubjectConsent.study_questions'
        db.add_column('cancer_subject_subjectconsent', 'study_questions',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubjectConsent.assessment_score'
        db.add_column('cancer_subject_subjectconsent', 'assessment_score',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubjectConsent.consent_copy'
        db.add_column('cancer_subject_subjectconsent', 'consent_copy',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubjectConsentAudit.consent_reviewed'
        db.add_column('cancer_subject_subjectconsent_audit', 'consent_reviewed',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubjectConsentAudit.study_questions'
        db.add_column('cancer_subject_subjectconsent_audit', 'study_questions',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubjectConsentAudit.assessment_score'
        db.add_column('cancer_subject_subjectconsent_audit', 'assessment_score',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubjectConsentAudit.consent_copy'
        db.add_column('cancer_subject_subjectconsent_audit', 'consent_copy',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubjectConsent.consent_reviewed'
        db.delete_column('cancer_subject_subjectconsent', 'consent_reviewed')

        # Deleting field 'SubjectConsent.study_questions'
        db.delete_column('cancer_subject_subjectconsent', 'study_questions')

        # Deleting field 'SubjectConsent.assessment_score'
        db.delete_column('cancer_subject_subjectconsent', 'assessment_score')

        # Deleting field 'SubjectConsent.consent_copy'
        db.delete_column('cancer_subject_subjectconsent', 'consent_copy')

        # Deleting field 'SubjectConsentAudit.consent_reviewed'
        db.delete_column('cancer_subject_subjectconsent_audit', 'consent_reviewed')

        # Deleting field 'SubjectConsentAudit.study_questions'
        db.delete_column('cancer_subject_subjectconsent_audit', 'study_questions')

        # Deleting field 'SubjectConsentAudit.assessment_score'
        db.delete_column('cancer_subject_subjectconsent_audit', 'assessment_score')

        # Deleting field 'SubjectConsentAudit.consent_copy'
        db.delete_column('cancer_subject_subjectconsent_audit', 'consent_copy')
    ...
    models = {
        ...
        'cancer_subject.activityandfunctioning': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 14, 0, 0)'}),
        ...
        'cancer_subject.locator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 14, 0, 0)'}),
