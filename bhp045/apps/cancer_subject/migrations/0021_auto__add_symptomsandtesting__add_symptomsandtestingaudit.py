...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SymptomsAndTesting'
        db.create_table('cancer_subject_symptomsandtesting', (
            ...
            ('subject_visit', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cancer_subject.SubjectVisit'], unique=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 10, 11, 3, 39, 342579))),
            ('symptom_prompt', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('symptom_date', self.gf('django.db.models.fields.DateField')(max_length=25, null=True, blank=True)),
            ('medical_doctor_date', self.gf('django.db.models.fields.DateField')(max_length=25, null=True, blank=True)),
            ('trad_doctor_date', self.gf('django.db.models.fields.DateField')(max_length=25, null=True, blank=True)),
            ('hiv_tested', self.gf('django.db.models.fields.CharField')(max_length=18)),
            ('hiv_test_result', self.gf('django.db.models.fields.CharField')(max_length=18, null=True, blank=True)),
            ('pos_date', self.gf('django.db.models.fields.DateField')(max_length=25, null=True, blank=True)),
            ('neg_date', self.gf('django.db.models.fields.DateField')(max_length=25, null=True, blank=True)),
            ('hiv_result', self.gf('django.db.models.fields.CharField')(max_length=18)),
            ('arv_art_therapy', self.gf('django.db.models.fields.CharField')(max_length=18, null=True, blank=True)),
            ('arv_art_start_date', self.gf('django.db.models.fields.DateField')(max_length=25, null=True, blank=True)),
            ('arv_art_now', self.gf('django.db.models.fields.CharField')(max_length=18, null=True, blank=True)),
            ('art_art_stop_date', self.gf('django.db.models.fields.DateField')(max_length=25, null=True, blank=True)),
        ))
        db.send_create_signal('cancer_subject', ['SymptomsAndTesting'])

        # Adding model 'SymptomsAndTestingAudit'
        db.create_table('cancer_subject_symptomsandtesting_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('subject_visit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_symptomsandtesting', to=orm['cancer_subject.SubjectVisit'])),
        ))
        db.send_create_signal('cancer_subject', ['SymptomsAndTestingAudit'])


    def backwards(self, orm):
        
        # Deleting model 'SymptomsAndTesting'
        db.delete_table('cancer_subject_symptomsandtesting')

        # Deleting model 'SymptomsAndTestingAudit'
        db.delete_table('cancer_subject_symptomsandtesting_audit')
    ...
    models = {
        ...
        'cancer_subject.activityandfunctioning': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 10, 11, 3, 39, 342579)'}),
        ...
        'cancer_subject.locator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 4, 10)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 10, 11, 3, 39, 147683)'}),
        ...
        'cancer_subject.symptomsandtesting': {
            ...
            'symptom_prompt': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
