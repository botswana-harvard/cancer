...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Locator.alt_contact_cell_number'
        db.add_column('cancer_subject_locator', 'alt_contact_cell_number',
                      self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LocatorAudit.alt_contact_cell_number'
        db.add_column('cancer_subject_locator_audit', 'alt_contact_cell_number',
                      self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Locator.alt_contact_cell_number'
        db.delete_column('cancer_subject_locator', 'alt_contact_cell_number')

        # Deleting field 'LocatorAudit.alt_contact_cell_number'
        db.delete_column('cancer_subject_locator_audit', 'alt_contact_cell_number')
