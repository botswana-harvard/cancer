...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OncologyTreatmentPlanAudit.comments'
        db.alter_column('cancer_subject_oncologytreatmentplan_audit', 'comments', self.gf('django.db.models.fields.CharField')(max_length=350, null=True))

        # Changing field 'OncologyTreatmentPlan.comments'
        db.alter_column('cancer_subject_oncologytreatmentplan', 'comments', self.gf('django.db.models.fields.CharField')(max_length=350, null=True))

    def backwards(self, orm):

        # Changing field 'OncologyTreatmentPlanAudit.comments'
        db.alter_column('cancer_subject_oncologytreatmentplan_audit', 'comments', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'OncologyTreatmentPlan.comments'
        db.alter_column('cancer_subject_oncologytreatmentplan', 'comments', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
