...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubjectOffStudy.reason'
        db.alter_column('cancer_subject_subjectoffstudy', 'reason', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'SubjectOffStudyAudit.reason'
        db.alter_column('cancer_subject_subjectoffstudy_audit', 'reason', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'SubjectOffStudy.reason'
        db.alter_column('cancer_subject_subjectoffstudy', 'reason', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'SubjectOffStudyAudit.reason'
        db.alter_column('cancer_subject_subjectoffstudy_audit', 'reason', self.gf('django.db.models.fields.CharField')(max_length=25))
