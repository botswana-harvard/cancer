...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cancer_subject_subjectconsent', 'subject_identifier', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=50))
        ...
        db.add_column('cancer_subject_subjectconsent_audit', 'subject_identifier_as_pk',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'SubjectConsentAudit.is_literate'
        db.add_column('cancer_subject_subjectconsent_audit', 'is_literate',
                      self.gf('django.db.models.fields.CharField')(default='-', max_length=3),
                      keep_default=False)

        # Adding field 'SubjectConsentAudit.witness_name'
        db.add_column('cancer_subject_subjectconsent_audit', 'witness_name',
                      self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'cancer_subject.activityandfunctioning': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 6, 0, 0)'}),
        ...
        'cancer_subject.locator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 6, 0, 0)'}),
