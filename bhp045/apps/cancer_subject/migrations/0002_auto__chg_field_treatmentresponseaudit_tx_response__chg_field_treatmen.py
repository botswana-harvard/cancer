...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TreatmentResponseAudit.tx_response'
        db.alter_column('cancer_subject_treatmentresponse_audit', 'tx_response', self.gf('django.db.models.fields.CharField')(max_length=350))

        # Changing field 'TreatmentResponse.tx_response'
        db.alter_column('cancer_subject_treatmentresponse', 'tx_response', self.gf('django.db.models.fields.CharField')(max_length=350))

    def backwards(self, orm):

        # Changing field 'TreatmentResponseAudit.tx_response'
        db.alter_column('cancer_subject_treatmentresponse_audit', 'tx_response', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'TreatmentResponse.tx_response'
        db.alter_column('cancer_subject_treatmentresponse', 'tx_response', self.gf('django.db.models.fields.CharField')(max_length=35))
    ...
    models = {
        ...
        'cancer_subject.treatmentresponse': {
            ...
            'tx_response': ('django.db.models.fields.CharField', [], {'max_length': '350'}),
