...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cancer_list_whoillness', (
        ...
        db.send_create_signal('cancer_list', ['WhoIllness'])

        # Adding model 'InfoDeterminant'
        db.create_table('cancer_list_infodeterminant', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ...
        db.send_create_signal('cancer_list', ['InfoDeterminant'])


    def backwards(self, orm):
        # Deleting model 'WhoIllness'
        db.delete_table('cancer_list_whoillness')

        # Deleting model 'InfoDeterminant'
        db.delete_table('cancer_list_infodeterminant')
